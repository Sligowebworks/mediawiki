 ...
 * @author Barrylb (http://www.mediawiki.org/wiki/User:Barrylb)
 * @copyright © 2006 Barrylb
...
if( defined( 'MEDIAWIKI' ) ) {
        ...
        $wgExtensionCredits['specialpage'][] = array( 'name' => 'Events', 'author' => 'Barrylb', 'url' => 'http://www.mediawiki.org/wiki/User:Barrylb' );
